...
export const ModelSelector: FC<ModelSelectorProps> = ({
	...
	return (
		<Select value={value} onValueChange={onValueChange} disabled={isDisabled}>
			<SelectTrigger
				className={cn(
					"h-6 w-auto gap-1.5 border-none bg-transparent px-1 py-0 text-xs shadow-none transition-colors hover:bg-transparent hover:text-content-primary focus:ring-0 [&>svg]:transition-colors [&>svg]:hover:text-content-primary",
					className,
				)}
			>
