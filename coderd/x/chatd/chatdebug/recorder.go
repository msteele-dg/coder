...
type stepHandle struct {
	...
	hadError bool
	// generation is incremented on every finish call. Stale callbacks
	// (e.g. context.AfterFunc safety nets from abandoned streams) use
	// this to detect that a newer finalization already ran and skip
	// the write, preventing terminal-state regression.
	generation int64
}
