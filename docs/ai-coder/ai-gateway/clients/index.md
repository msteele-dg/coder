...
| Client                           | OpenAI | Anthropic | BYOK OpenAI | BYOK Anthropic | ChatGPT Sub. | Claude Sub. | Notes                                                                                                                                                  |
|----------------------------------|--------|-----------|-------------|----------------|--------------|-------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Mux](./mux.md)                  | ✅      | ✅         |             |                |              |             |                                                                                                                                                        |
...
*Legend: ✅ supported, ⚙️ requires AI Gateway Proxy, ❌ not supported, - not applicable, empty = not tested.*
